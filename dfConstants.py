...
PROC_DATE_FROM_RATE = ('DF RATE', 'TX DAT DEP')
PROC_CURRENT_RATE = ('CUR RATE', 'TX ACT')
PROC_CAPITAL_GAIN = ('CAP GAIN', 'PLUS-VAL CAP')
PROC_CAPITAL_GAIN_PERCENT = ('CAP GAIN %', 'P-V CAP %')
PROC_YIELD = ('YIELD', 'INTERETS')
